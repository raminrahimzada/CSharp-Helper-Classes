namespace AnimatorNS
{
    ...
    internal class DecorationControl : UserControl
    {
        ...
        public DecorationControl(AnimatorNS.DecorationType type, Control decoratedControl)
        {
        ...
        private byte[] GetPixels(Bitmap bmp)
        {
            ...
            BitmapData bitmapdata = bmp.LockBits(rect, ImageLockMode.ReadOnly, format);
        ...
        {
            if (this.DecorationType == AnimatorNS.DecorationType.BottomMirror)
            {
        ...
        public AnimatorNS.DecorationType DecorationType { get; set; }
